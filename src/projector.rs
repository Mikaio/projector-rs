...
mod test {
    ...
    fn get_value() {
        ...
        assert_eq!(proj.get_value("fm"), Some(&String::from("is_good")));
    }
    ...
    fn set_value() {
        ...
        proj.set_value(String::from("fm"), String::from("is_pretty_nice"));

        assert_eq!(proj.get_value("foo"), Some(&String::from("bar4")));
        assert_eq!(proj.get_value("fm"), Some(&String::from("is_pretty_nice")));
    }
